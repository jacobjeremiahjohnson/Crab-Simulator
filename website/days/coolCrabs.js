...
export async function execute(queue) {
  ...
  let answer = await choice(["Hey, step off", "Wait, you're a crab of the Uca species"])
  ...
  if(answer == 1) {
    ...
    await fprint("Wait, you're a crab of the Uca species. That means you're primarily herbivorous (although also may eat organic debris and waste), thus meaning that I am not fresh meat, as you would not eat meat.\n", "cyan", 2)
