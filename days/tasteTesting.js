...
export async function execute(queue){
    ...
    await fprint("Yeah I know what a curse is, why did you put one on my refrigerator?\n", "cyan")
    await fprint("I was getting to that, chill.", "green", 1)
    await fprint("Anyways, uh, I saw this cool thing in a Vsauce video. Basically there's gonna be three cans of soup in your fridge. Two of them are completely normal, but one of them was made with a crab stock. Choose carefully, or you may be consuming your own kind!\n", "green", 1)
    ...
    // All my homies hate let
		// ^ I sincerely apologize for my previous statement. I love let like my own child.
    ...
    if (newAnswer == 2) {
        answer = switchAnswer
        await fprint("You fool! Switching increases your chances of getting the cursed can to 2/3! Now let's see what the cursed can really is...\n", "green")
    } else {
    ...
    if (answer == cursedCan) {
        ...
        await fprint("The microwave chimes deafeningly loud, a piping hot can of soup inside. What have you become? Eating one of your own? Don't think that this isn't your fault. You deserve this.", "dim", 1)
        await fprint("Your spoon dips below the surface of the tantalizing crab stock soup. You bring it closer and closer to your mouth.", "dim", 1.5)
        await fprint("With a single gulp, you've committed the cardinal sin.", "dim", 2)
        await fprint("You collapse to the ground, longing for the days where you didn't have to suffer like this. Tears stream down your eyes as you feel your ancestors looking down upon you in shame. Crabs, crayfish, lobsters, cats, dogs, ants, humans. They peer with a look of disgust over what you have become.\n", "dim", 3)
